...
def main():
    ...
    parser.add_argument(
        "--background",
        action="store_true",
        help="Include background sections during enrichment (disabled by default)",
    )
    ...
    try:
        ...
        asyncio.run(orchestrator.run(force_hours=args.hours, include_background=args.background))
